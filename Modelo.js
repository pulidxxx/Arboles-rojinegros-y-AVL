...
function insertarNodoAVL(nodo, valor) {
  ...
  if (valor < nodo.valor) {
    nodo.hijoIzquierdo = insertarNodoAVL(nodo.hijoIzquierdo, valor);
...
function EliminarNodoAVL(nodo, valor) {
  ...
  if (valor < nodo.valor) {
    nodo.hijoIzquierdo = EliminarNodoAVL(nodo.hijoIzquierdo, valor);
  } else if (valor > nodo.valor) {
    ...
    if (nodo.hijoIzquierdo == null && nodo.hijoDerecho == null) {
      ...
      nodo.hijoDerecho = EliminarNodoAVL(nodo.hijoDerecho, min.valor);
...
function InsertarNodoRojoYNegro(nodo, valor) {
  ...
  if (esRojo(nodo.hijoIzquierdo) && esRojo(nodo.hijoDerecho)) {
    ...
    // Se comprueba el caso simetrico
    if (
    ...
    // Caso 3 (Tio negro, nodo x es hijo izquierdo)
    ...
    if (esRojo(nodo.hijoIzquierdo.hijoIzquierdo)) {
      ...
      //(Caso 2)
      // Rotar a la izquierda y luego a la derecha
      nodo.hijoIzquierdo = rotacionIzquierda(nodo.hijoIzquierdo);
      nodo.color = ROJO;
      nodo.hijoIzquierdo.color = NEGRO;
      nodo = rotacionDerecha(nodo);
